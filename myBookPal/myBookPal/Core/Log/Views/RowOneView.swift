...
#Preview {
    RowOneView(textOne: "Unexpected", textTwo: "Cliffhanger", textThree: "Revelation", textFour: "Dramatic", tagArray: .constant([Tag(text: "", color: ""), Tag(text: "", color: ""), Tag(text: "", color: "")]))
}
